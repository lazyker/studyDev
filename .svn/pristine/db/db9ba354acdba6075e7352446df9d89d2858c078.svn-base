...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/toastr.min.css" />
	...
	<script src="${pageContext.request.contextPath}/resources/js/vendor/cozel.js" type="text/javascript"></script>
</head>
