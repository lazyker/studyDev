...
6 : 기타',
	...
	STORED_FILE_NM varchar(550) COMMENT '실제 저장된 파일명',
...
(
	...
	USR_ID varchar(20) COMMENT '등록자 아이디',
	CON_ID varchar(20) COMMENT '컨설턴트 아이디',
...
(
	...
	CON_ORDER int(3) COMMENT '정렬순서',
	FIELD varchar(1000) COMMENT '전문분야',
	-- 홈페이지 공개여부
	H_PUBLIC_YN char(1) DEFAULT 'Y' COMMENT '홈페이지 공개여부 : 홈페이지 공개여부',
...
) COMMENT = '고객사-담당자 : AUTO_INCREMENT';
...
(
	...
	POS_NM varchar(100) COMMENT '포지션 이름',
	COM_ID varchar(11) COMMENT '회사 아이디',
	COM_NM varchar(40) COMMENT '회사명',
	...
	S_CON_NM varchar(20) COMMENT '부 컨설턴트 이름',
	POS_STATUS char(1) COMMENT '진행상태',
	JOB1 varchar(11) COMMENT '직무 1단계',
	JOB2 varchar(11) COMMENT '직무 2단계',
	EDU char(1) COMMENT '학력',
	FROM_RANK char(1) COMMENT 'FROM 직급',
	TO_RANK char(1) COMMENT 'TO 직급',
	CAREER varchar(30) COMMENT '경력',
	LANG varchar(40) COMMENT '외국어',
	PLACE varchar(20) COMMENT '근무지',
	PUBLIC_YN char(1) COMMENT '인트라넷(내부)공개여부',
	TASK mediumtext COMMENT '업무내용',
	POS_CONDITION mediumtext COMMENT '자격요건',
	...
	BASE varchar(20) COMMENT '기본급',
	BONUS varchar(20) COMMENT '성과급',
	ETC mediumtext COMMENT '기타정보',
	REG_DATE datetime COMMENT '등록일시',
	MOD_DATE datetime COMMENT '수정일시',
	DEL_DATE datetime COMMENT '삭제일시',
	PRIMARY KEY (POS_ID)
...
(
	...
	STATE_DATE varchar(10) COMMENT '진행상태날짜',
	REG_DATE datetime COMMENT '등록일시',
	DEL_DATE datetime COMMENT '삭제일시',
	-- 사용처가 어딘지 모르리 상황봐서 삭제
	POS_CON_ID varchar(11) COMMENT '뭔지모름 : 사용처가 어딘지 모르리 상황봐서 삭제'
) COMMENT = '추천 진행상태';
...
(
	SCH_ID varchar(11) NOT NULL COMMENT '스케줄 아이디',
	...
	-- 메모
	MEMO varchar(1000) COMMENT '메모 : 메모',
...
(
	USR_ID varchar(11) NOT NULL COMMENT '후보자 아이디',
	USR_NM varchar(60) COMMENT '후보자 이름',
	INDUSTRY1 varchar(11) COMMENT '업종1',
	INDUSTRY2 varchar(11) COMMENT '업종2',
	JOB1 varchar(11) COMMENT '직무1',
	JOB1_NM varchar(30) COMMENT '직무명1',
	JOB2 varchar(11) COMMENT '직무2',
	JOB2_NM varchar(30) COMMENT '직무명2',
	...
	-- 학력1
	ACADEMIC_1 varchar(380) COMMENT '학력1 : 학력1',
	-- 학력2
	ACADEMIC_2 varchar(220) COMMENT '학력2 : 학력2',
	-- 학력3
	ACADEMIC_3 varchar(200) COMMENT '학력3 : 학력3',
	-- 학력4
	ACADEMIC_4 varchar(200) COMMENT '학력4 : 학력4',
	C_NAME varchar(260) COMMENT '경력회사',
	SUMMARY mediumtext COMMENT '경력요약',
	DETAIL mediumtext COMMENT '상세경력',
	SOURCES varchar(2) COMMENT '출처',
	CON_ID varchar(20) COMMENT '등록자 아이디',
	-- 등록자 이름
	CON_NM varchar(20) COMMENT '등록자 이름 : 등록자 이름',
	PHONE varchar(128) COMMENT '연락처',
	MOBILE varchar(128) COMMENT '휴대폰',
	EMAIL varchar(128) COMMENT '이메일',
	REG_DATE datetime COMMENT '등록일시',
...
(
	MAIL_TO varchar(50) COMMENT '수신메일주소',
	MAIL_FROM varchar(50) COMMENT '발신메일주소',
	MAIL_TITLE varchar(100) COMMENT '메일제목'
) COMMENT = '메일관리';
